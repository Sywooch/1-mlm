...
<head>
    ...
    <title>1-й млм ресурс</title><!-- Responsive Styles and Valid Styles -->
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 640px){
			...
			body[yahoo] .topheader{width: 395px !important;}
		...
		@media only screen and (max-width: 479px){
			...
			body[yahoo] .topheader{width: 252px !important;}
...
<body yahoo="fix" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="2b2e34" style="background-image: url(<?=Yii::getAlias('@web') ?>mail/img/main-bg.png); background-size: 100% 100%; background-position: top center;" background="<?=Yii::getAlias('@web') ?>mail/img/main-bg.png">
		...
		<tr>
			<td>
				<table border="0" align="center" width="510" cellpadding="0" cellspacing="0" bgcolor="1984c1" style="border-top-left-radius: 3px; border-top-right-radius: 3px;" class="topheader main_color">
		...
		<tr>
			<td>
				<table border="0" align="center" width="568" cellpadding="0" cellspacing="0" class="container590 bodybg_color" style="background-image: url(http://themastermail.com/alerta/notif2/img/bg.png); background-size: 100% 523px; background-position: top center; background-repeat: no-repeat;" background="http://themastermail.com/alerta/notif2/img/bg.png">
					...
					<tr class="show" style="display: none;"><td height="20" style="font-size: 20px; line-height: 20px;">&nbsp;</td></tr>
					
					<tr>
						<td align="center" style="color: #454647; font-size: 18px; font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; line-height: 20px;" class="title_color main-header">
					...
					<tr>
						<td>
							<table border="0" width="440" align="center" cellpadding="0" cellspacing="0" class="container580">				
								<tr>
									<td align="center" style="color: #9f9f9f; font-size: 14px; font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; line-height: 24px;" class="resize-text text_color">
...
<hr>
					...
					<tr>
						<td align="center">
							...
							<table border="0" align="center" width="190" cellpadding="0" cellspacing="0" bgcolor="1984c1" style="border-radius: 5px;" class="cta-btn main_color">
									...
									<td>
										<table border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
											...
											<tr>
				                				...
				                				<td align="left" style="color: #ffffff; font-size: 14px; font-family: 'Montserrat', sans-serif;">
				                					<!-- ======= main section button ======= -->
					                    		...
					                    		<td width="25" align="right">
		                    						<img align="bottom" width="13" height="13" style="width: 13px; height: 13px;" src="http://themastermail.com/alerta/notif2/img/arrow.png" />
		                    					</td>
					...
					<tr><td height="5" style="font-size: 30px; line-height: 5px;">&nbsp;</td></tr>
								...
								<tr>
									<td align="center" style="color: #9f9f9f; font-size: 14px; font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; line-height: 24px;" class="resize-text text_color">
										<div style="line-height: 24px">
                                            ...
                                            <b style="color: #454647;font-size: 16px;">Только для Вас! </b><br>


                                            Мы решили провести Акцию  <b style="color: #F64747;">« Свой МЛМ Центр »</b><br> Узнайте подробнее сейчас -  <a href="http://1-mlm.com/777-28020677.html"  target="_blank" >ЗДЕСЬ</a>
			...
			<td>
				<table border="0" width="510" align="center" cellpadding="0" cellspacing="0" class="container590">
					...
					<tr>
						...
						<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Nunito', sans-serif; font-weight: 300; mso-line-height-rule: exactly; line-height: 30px;" class="text_color">
							<div style="line-height: 30px">
								
								<!-- ======= section text ======= -->
								
	        					
	        						© 2016   1-й МЛМ Ресурс. Автоматизация млм рекрутинга.
