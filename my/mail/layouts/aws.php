...
<table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%" >
    <tr>
        <td align="center" valign="top" style="background:#00989a;" width="100%">
            <center>
                                    ...
                                    <td class="bg bg1" style="background-color:#ffffff;">
                                        ...
                                        <center>
                                            <table style="margin: 0 auto" cellpadding="0" cellspacing="0" class="force-width-80">
                                                <tr>
                                                    <td class="mobile-resize" style="color:#00989a; font-size: 22px; font-weight: 600; text-align: left; vertical-align: top;">
                                                        <span319db5>Здравствуйте, %USERNAME%</span>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                                <tr>
                                                    <td style="text-align:left; color: #6f6f6f;">
                                                        <br>
                                                        <p319db5>
                                                            В честь открытия 1 mlm ресурса мы проводим уникальную акцию
                                                            И возможно именно Вы  будете победителем
                                                            Получив годовой абонемент на максимальный тариф для использования сервиса
                                                            <br /><br /><br />
                                                            Для участия в акции авторизируйтесь на сайте www.1-mlm.com
                                                            и в разделе - Рекламные материалы поделитесь Приглашением на вебинар в честь открытия сайта
                                                            <br /><br /><br />
                                                            Среди участников вебинара будет разыгран абонемент в прямом эфире
                                                            если при проверке у вас будет пост на вебинар на вашей странице
                                                            </p>
                                                </tr>
                                            </table>
                                        </center>
