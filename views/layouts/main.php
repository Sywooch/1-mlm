                    ...
                    <li class="dropdown dropdown-extended dropdown-notification dropdown-dark" id="header_notification_bar">
                        ...
                        <ul class="dropdown-menu">
                            <li class="external">
                                ...
                                <a href="page/page_user_profile_1.html">view all</a>
                            </li>
                            <li>
                    ...
                    <li class="dropdown dropdown-extended dropdown-inbox dropdown-dark" id="header_inbox_bar">
                        ...
                        <ul class="dropdown-menu">
                            <li class="external">
                                ...
                                <a href="page/app_inbox.html">view all</a>
                            </li>
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="mertonic/layouts/layout3/img/avatar2.jpg" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="mertonic/layouts/layout3/img/avatar3.jpg" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="mertonic/layouts/layout3/img/avatar1.jpg" class="img-circle" alt=""> </span>
                                                    <span class="subject">
            ...
            <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                <li class="nav-item start active open">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item start ">
                            <a href="page/dashboard_3.html" class="nav-link ">
                        ...
                        <div class="portlet-body" id="chats">
                            <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                                <ul class="chats">
                                    ...
                                    <li class="in">
                                        <img class="avatar" alt="" src="mertonic/layouts/layout/img/avatar1.jpg" />
                                        <div class="message">
                                            <span class="arrow"> </span>
...
<div id="w0" class="fade modal" role="dialog" tabindex="-1">
    ...
    <div class="modal-dialog"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
        </a><div class="modal-content"><!--<a href="javascript:;"
                ...
                <div class="modal-header">
                    ...
                    <h2 style="cursor:default;">Вход</h2>
                </div>
                <!--</a>--><div class="modal-body"><a href="javascript:;"
                        class="dropdown-toggle"
                        data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                </a>
                <div class="eauth" align="center" id="w1">
                    <a href="javascript:;" class="dropdown-toggle"
                       data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    </a>
                    <ul class="eauth-list">
                        ...
                        <li class="eauth-service eauth-service-id-facebook"
                            ...
                            <a href="javascript:;" class="dropdown-toggle"
                               data-toggle="dropdown" data-hover="dropdown"
                               data-close-others="true"></a>
                            <a class="eauth-service-link"
                               href="/index.php?r=site%2Flogin&amp;service=facebook"
                               data-eauth-service="facebook"><img border="0" height="90"
                                     src="http://www.seeklogo.net/wp-content/uploads/2013/11/facebook-flat-vector-logo-400x400.png" /></a>
                        </li>
                        <li class="eauth-service eauth-service-id-vkontakte"
                            style="list-style-type: none;display: inline;">
                            <a class="eauth-service-link" href="/index.php?r=site%2Flogin&amp;service=vkontakte"
                               data-eauth-service="vkontakte"><img border="0" height="111"
                                     src="http://abali.ru/wp-content/uploads/2013/11/vk_logo_small_blue.png" /></a>
                        </li>
                    </ul>
                </div>
